...
from agent_search.providers.context7 import Context7Provider
from agent_search.providers.exa import ExaSearchProvider
...
async def test_context7_provider_normalizes_library_results(monkeypatch):
    ...
    monkeypatch.setattr("agent_search.providers.context7.httpx.AsyncClient", FakeAsyncClient)
...
async def test_exa_provider_reports_bad_request_as_parameter_error(monkeypatch):
    ...
    monkeypatch.setattr("agent_search.providers.exa.httpx.AsyncClient", FakeAsyncClient)

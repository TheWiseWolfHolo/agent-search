...
from agent_search.providers.anysearch import AnySearchProvider
...
async def test_anysearch_jsonrpc_success_parses_markdown_and_auth_header(monkeypatch):
    ...
    monkeypatch.setattr("agent_search.providers.anysearch.httpx.AsyncClient", FakeAnySearchClient)
